...
//     // 1️ 유저 생성 (POST)
//     @PostMapping
//     public ResponseEntity<UserWithoutAuth> createUser(@RequestBody UserRequestDto requestDto) {
//         UserWithoutAuth user = userService.createUser(requestDto.getEmail(), requestDto.getPassword());
//         return ResponseEntity.ok(user);
//     }

//     // 2️ 유저 조회 (GET)
//     @GetMapping("/{id}")
//     public ResponseEntity<UserWithoutAuth> getUser(@PathVariable Long id) {
//         UserWithoutAuth user = userService.getUserById(id);
//         return ResponseEntity.ok(user);
//     }

//     // 3️ 유저 전체 조회 (GET)
//     @GetMapping
//     public ResponseEntity<List<UserWithoutAuth>> getAllUsers() {
//         List<UserWithoutAuth> users = userService.getAllUsers();
